...
namespace chart_utils {
	...
	void drawChartWithSteps(string title, string xlabel, string ylabel, string inputFile, string outputFile, int width, int height, float xTics, float xOffset, float yOffset) {
		Gnuplot gplot;
