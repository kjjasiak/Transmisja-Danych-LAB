...
namespace chart_utils {
	...
	void drawChartMultiPlot(string title, string title1, string title2, string title3, string title4, string xlabel, string ylabel, string outputFile, string inputFile1, string inputFile2, string inputFile3,  string inputFile4, int width, int height) {
		Gnuplot gplot;
